...
| <span data-proof="authored" data-by="ai:claude">`skills/index.md`</span>                 |                                                                                                    |
...
<!-- PROOF
{
  ...
  "marks": {
    "m1777279462411_4": {
      "kind": "replace",
      "by": "ai:claude",
      "createdAt": "2026-04-27T08:44:22.411Z",
      "range": {
        "from": 3734,
        "to": 3859
      },
      "content": "sf- prefix is the Salesforce namespace, used for every agent and skill in this plugin.",
      "status": "pending"
    },
    "m1777279462406_3": {
      "kind": "replace",
      "by": "ai:claude",
      "createdAt": "2026-04-27T08:44:22.406Z",
      "range": {
        "from": 5652,
        "to": 5728
      },
      "content": "Skill index — core workflow skills, domain knowledge skills, V3 capability skills",
      "status": "pending"
    },
    "m1777279462399_2": {
      "kind": "replace",
      "by": "ai:claude",
      "createdAt": "2026-04-27T08:44:22.399Z",
      "range": {
        "from": 6470,
        "to": 6814
      },
      "content": "Component Counts (v3.0.0-beta.1)\nSkills: 45 (7 core workflow + 11 Salesforce domain knowledge + 5 workflow support + 22 V3 capability skills).\nAgents: 59 (6 Apex + 4 Flow + 5 LWC + 6 Integration + 4 Architecture + 5 Research + 5 Workflow + 24 V3 review/research personas).",
      "status": "pending"
    }
  }
}
